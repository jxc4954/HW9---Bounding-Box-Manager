...
public:
	...
	*/
	...
	void GenerateAABB(matrix4 a_mModelToWorld, String a_sInstanceName);
	...
	*/
	...
	void SetAABBSpace(matrix4 a_mModelToWorld, String a_sInstanceName);
	...
	*/
	...
	int IdentifyAABB(String a_sInstanceName);
	...
	*/
	...
	void AddAABBToRenderList(String a_sInstanceName = "ALL");
